...
- (void)sendDecibelValueNotification:(float)decibelValue {
   NSDictionary *userInfo = @{@"SpeakValue": @(decibelValue)};
   [[NSNotificationCenter defaultCenter] postNotificationName:@"SpeakingValueNotificationNotification" object:nil userInfo:userInfo];
